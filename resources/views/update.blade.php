    ...
    <div class="container mt-4">
        ...
        <div class="card">
            ...
            @csrf
                    ...
                    <div class="form-group">
                        UMUR
                        <input type="text" id="nama" name="umur" class="form-control" required="" value="{{$data->umur}}">
                    </div>

                    <div class="form-group">
                        EMAIL
                        <input type="text" id="nama" name="email" class="form-control" required="" value="{{$data->email}}">
                    </div>
